...
class TestNewArticlesDigestSummaryView(TestCase):
    def setUp(self) -> None:
        self.user = User.objects.create_user(
            username="u",
            email="u@test.com",
        )
        self.url = reverse("new-articles-digest-summary")
    ...
    @patch("users.views.subscriptions.get_new_articles_digest_summary")
    def test_calls_service_with_default_since_publish_sequence_zero(
        self,
        mock_get_new_articles_digest_summary,
    ) -> None:
        self.client.force_login(self.user)
        mock_get_new_articles_digest_summary.return_value = {
            "has_new": False,
        ...
        mock_get_new_articles_digest_summary.assert_called_once_with(
    ...
    def test_invalid_since_publish_sequence_returns_bad_request(
        ...
        mock_get_new_articles_digest_summary.assert_not_called()
