# Generated by Django 5.1.1 on 2026-03-03 19:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("users", "0004_remove_profile_subscribers_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="user",
            name="latest_published_article_id",
            field=models.BigIntegerField(db_index=True, default=0),
        ),
        migrations.AddField(
            model_name="user",
            name="subscriptions_last_seen_article_id",
            field=models.BigIntegerField(db_index=True, default=0),
        ),
        migrations.AddField(
            model_name="user",
